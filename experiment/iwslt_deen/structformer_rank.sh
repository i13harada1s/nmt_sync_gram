...
MODEL_DIR=checkpoints/iwslt14_deen_bpe10k/structformer_rank
RESULT_DIR=experiments/iwslt_deen/results/bpe10k/structformer_rank
mkdir -p $RESULT_DIR
...
poetry run fairseq-train $DATA_DIR \
    ...
    --sync-lambda 0.005 --sync-method "rank" --hinge-margen 0.1 \
...
MODEL_DIR=checkpoints/iwslt14_deen_nobpe/structformer_rank_test
RESULT_DIR=experiments/iwslt_deen/results/nobpe/structformer_rank_test
mkdir -p $RESULT_DIR
