...
REFERENCE=$ALIGN_SCRIPTS/test/roen.talp
...
DATADIR=data/europarl_roen_spm32k/tmp
EXPERIMENT=experiments/results/europarl_roen_spm32k/fastalign_tkn
mkdir -p $EXPERIMENT
...
DATADIR=data/europarl_roen_spm32k
EXPERIMENT=experiments/results/europarl_roen_spm32k/fastalign_spm
mkdir -p $EXPERIMENT
info "create train data for run_fastalign.sh."
for l in $src $tgt; do
    check_file $DATADIR/train.$l
