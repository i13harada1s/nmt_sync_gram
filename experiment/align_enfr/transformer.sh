...
MODEL_DIR=checkpoints/align_enfr_spm32k/transformer_${SRC}_${TGT}
mkdir -p $RESULT_DIR
...
MODEL_DIR=checkpoints/align_enfr_spm32k/transformer_${TGT}_${SRC}
mkdir -p $RESULT_DIR
...
pipenv run python $EVALUATE $GOLD_ALIGN $RESULT_DIR/transformer.${SRC}${TGT}.talp --fAlpha 0.5 --oneRef 
